...
namespace NovemberProjektet
{
    class Carrier : Ship
    {
        public Carrier(int i)
        {
            xPos = 0;
            yPos = 0;
            shipLength = 5;
            direction = "vertical";
            PlayerPlaceCarrier(xPos, yPos, shipLength, i);
        }

        static void PlayerPlaceCarrier(int xPos, int yPos, int shipLength, int i){
            bool finished = false;
